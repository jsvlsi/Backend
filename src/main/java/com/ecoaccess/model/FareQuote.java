...
public class FareQuote {
    ...
    public int base(){return base;} public int tax(){return tax;} public int gross(){return gross;} public int discount(){return discount;} public int payable(){return payable;}
}
