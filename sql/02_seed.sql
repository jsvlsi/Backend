...
insert into staff(id,employee_id,name,password_hash,job_role,status) values
 ('STF1','STF1001','Aditya Chavan','8776f108e247ab1e2b323042c049c266407c81fbad41bde1e8dfc1bb66fd267e','Staff','Available'),
 ('STF2','STF1002','Neeraj','8776f108e247ab1e2b323042c049c266407c81fbad41bde1e8dfc1bb66fd267e','Staff','Available') on conflict (id) do nothing;
...
insert into resources values ('RS-WC-MUM','Mumbai Central','Wheelchair',8),('RS-IV-MUM','Mumbai Central','Inter Vehicle',6),('RS-WC-THA','Thane','Wheelchair',6),('RS-IV-THA','Thane','Inter Vehicle',5),('RS-WC-PUN','Pune Junction','Wheelchair',4),('RS-IV-PUN','Pune Junction','Inter Vehicle',3) on conflict (id) do nothing;
